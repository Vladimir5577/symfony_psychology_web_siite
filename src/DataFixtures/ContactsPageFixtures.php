            ...
            [
                ...
                'posts' => [
                    [
                        ...
                        'description' => 'Записаться на консультацию можно по телефону или через форму ниже. Опишите кратко ваш запрос (по желанию) — я отвечу в течение 1–2 рабочих дней и предложу варианты времени для первой встречи. Все данные обрабатываются конфиденциально.',
                        'position' => 0,
                    ],
                ],
            ],
